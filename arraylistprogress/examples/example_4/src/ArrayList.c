...
int al_add(ArrayList* plist, void* pElement)
{
    ...
    if(plist!=NULL && pElement!=NULL)
    {
        ...
        if(plist->size!=plist->reservedSize && valaux==1)
        {
...
int resizeUp(ArrayList* plist)
{
    ...
    if(plist!=NULL)
    {
            void** auxListElemten;
                ...
                auxListElemten =(void**) realloc(plist->pElements,sizeof(void *)* (plist->reservedSize + AL_INCREMENT));
                if(auxListElemten != NULL)
                {
                    plist->pElements=auxListElemten;
